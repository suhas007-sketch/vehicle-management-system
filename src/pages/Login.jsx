...
export default function Login() {
    ...
    const submitHandler = async (e) => {
        ...
        const timeout = setTimeout(() => {
            setLoading(false);
            setError('Login timed out. Please check your connection or Supabase setup.');
        }, 10000);
        ...
        try {
            ...
            console.log('Login response successful:', authUser);
            ...
            const msg = err.message || err.error_description || 'Something went wrong during login.';
            ...
            <div className="w-full max-w-lg relative z-10">
                <div className="flex justify-center mb-10">
                    <div className="p-5 bg-white/[0.02] border border-white/5 rounded-[32px] shadow-glow-sm">
                        <Zap className="w-10 h-10 text-primary shadow-glow" />
                    </div>
                </div>
                ...
                <Card className="bg-surface-dark/40 border border-white/5 shadow-[0_0_100px_rgba(0,0,0,0.8)] rounded-[48px] overflow-hidden backdrop-blur-xl">
                    <CardContent className="p-12">
                        <div className="text-center mb-10 space-y-3">
                            <h2 className="text-4xl font-black italic uppercase tracking-tighter text-textMain">Welcome <span className="text-primary">Back</span></h2>
                            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-textMuted opacity-50">Operator Authentication Required</p>
                        </div>
                        ...
                        <form onSubmit={submitHandler} className="space-y-6">
                            ...
                            <div className="pt-4">
                                ...
                                >
                                    <span className="font-black italic uppercase tracking-widest text-sm">Initiate Sync</span>
                        ...
                        <div className="mt-10 text-center pt-8 border-t border-white/5">
                            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-textMuted opacity-50">
                                New Operator? <Link to="/register" className="text-primary hover:text-primaryDark transition-all italic ml-2">Register License</Link>
                            </p>
                        </div>
                    </CardContent>
                </Card>
                ...
                <div className="mt-8 flex justify-center items-center gap-4 opacity-20">
                    ...
                    <span className="text-[8px] font-black uppercase tracking-[0.4em] text-textMuted italic">End-to-End Encrypted Data Node</span>
                </div>
            </div>
        </PageTransition>
    );
